                            ...
                            <div class="col-lg-4 col-sm-12 col-md-12 reveal revealleft">
                                <div class="w-[8rem] h-[8rem]">
                                    <img src="{{ asset('assets/images/brand/logo1.png') }}"
                                        class="w-full h-full object-cover -ml-[1.5rem]" alt="">
                                </div>
                            </div>
                    ...
                    <footer class="main-footer px-0 pb-0">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="copyright-top">
                                <p class="">
                                    Copyright © Les Pros de la Comm du Bénin.
                                </p>
                            </div>
                            <div class="address mt-[.5rem] md:mt-0">
                                ...
                                <h2>
                                    <span class="font-bold">Tel :</span> +229 21 31 21 93
                                </h2>
                                <h2>
                                    <span class="font-bold">Email :</span> contact@lesprosdelacomm.bj
                                </h2>
                            </div>
