...
@section('content')
    ...
    <section class="relative">
        <div class="banner-carousel">
            <div style="background:url('{{ asset('assets/images/brand/banner1.jpg') }}') center; background-repeat: no-repeat; background-size: cover;"
                class="h-[550px] w-full">
                <div class="h-full w-full bg-black opacity-70"></div>
            </div>

            <div style="background:url('{{ asset('assets/images/brand/banner2.jpg') }}') center; background-repeat: no-repeat; background-size: cover;"
                class="h-[550px] w-full">
                <div class="h-full w-full bg-black opacity-70"></div>
            </div>
        </div>
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  w-[80%] md:w-[60%]">
            <div class="flex flex-col gap-4">
                <h1 class="text-[#FFFFFF] text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] text-center">Bienvenue sur le site
                    officiel de l’association des
                    Pros
                    de
                    la Comm du
                    Bénin</h1>
                <p class="text-[#FFFFFF] text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] text-center">Rejoignez un réseau
                    dynamique dédié à l’innovation, à
                    la
                    formation et à
                    la mise en valeur des métiers de la communication.</p>
    ...
    <section class="container mx-auto px-5 sm:px-0 mt-[5rem]">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div
                class="flex flex-col gap-3 p-4 bg-[#e7f1ea] hover:shadow-lg transition-transform duration-300 hover:-translate-y-2 reveal">
                <div class="flex justify-between items-center">
                    <div class="w-[40px] h-[40px]">
                        <img src="{{ asset('assets/images/svgs/goal.svg') }}" class="w-full h-full object-cover"
                            alt="">
                    </div>
                    <h1 class="text-[2rem] md:text-[2.5rem] lg:text-[3rem]">01</h1>
                </div>
                <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem]">Fédérer les professionnels de la communication
                </h1>
                <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Rassembler les experts du secteur pour favoriser
                    les échanges, les collaborations et la
                    croissance
                    collective.</p>
            </div>
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    ...
                    <h1 class="text-[2rem] md:text-[2.5rem] lg:text-[3rem]">02</h1>
                </div>
                <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem]">Former et accompagner les talents</h1>
                <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Organiser des formations, ateliers et séances de
                    mentorat pour développer les compétences
                    et renforcer l’employabilité.</p>
            </div>
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    ...
                    <h1 class="text-[2rem] md:text-[2.5rem] lg:text-[3rem]">03</h1>
                </div>
                <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem]">Promouvoir l’éthique et l’innovation</h1>
                <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Encourager les bonnes pratiques, l’éthique
                    professionnelle et l’innovation dans
                    les
    ...
    {{-- START ABOUT --}}
    <section class="container mx-auto px-5 sm:px-0 mt-[5rem]">
        <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] text-[#098752] text-center font-bold mb-[2rem]">Qui
            sommes-nous ?</h1>
        <div class="about-container gap-8">
            <div class="w-[100%] md:w-1/2 flex justify-center h-[300px] sm:h-[400px]">
                <div class="w-[280px] sm:w-[350px] h-full relative">
                    <div class="w-[160px] h-[180px] sm:w-[200px] sm:h-[220px] overflow-hidden">
                        <img src="{{ asset('assets/images/brand/banner1.jpg') }}" class="w-full h-full object-cover"
                            alt="">
                    </div>
                    <div
                        class="w-[160px] h-[180px] sm:w-[200px] sm:h-[220px] overflow-hidden absolute bottom-0 right-0 shadow-lg">
                        <img src="{{ asset('assets/images/brand/banner1.jpg') }}" class="w-full h-full object-cover"
                            alt="">
                    </div>
                </div>
            ...
            <div class="w-[100%] md:w-1/2 mt-[2rem] md:mt-0">
                <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">LES PROS DE LA COMM DU BENIN rassemble les
                    professionnels de la communication du
                    Bénin. Pour être reconnu
                    comme professionnel de la communication, il convient d’avoir acquis la compétence nécessaire par ses
                    études, ses travaux ou son expérience et d’avoir, pour activité essentielle, apporté ses services à un
                    groupe (collectivité, entreprise), afin d’étudier les problèmes de communication qui se posent à ce
                    groupe, de les résoudre en proposant les
    ...
    <section class="mt-[5rem] bg-[#e7f1ea] py-[3rem]">
        <div class="container mx-auto px-5 sm:px-0">
            <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] text-[#098752] text-center font-bold mb-[2rem]">Le
                Bureau Général</h1>
            <div class="ms-[0rem] sm:ms-[5rem]">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <div class="h-[20rem] rounded-lg relative overflow-hidden">
                        <img src="{{ asset('assets/images/faces/face5.jpeg') }}"
        ...
        <div class="text-center mt-[2rem]">
            <a class="text-[1rem] text-[#000000] hover:text-[#000000] hover:underline cursor-pointer"
                href="{{ route('view.office') }}#memberSection">Voir
                plus <span class="fa fa-arrow-right"></span> </a>
        </div>
    </section>
    {{-- END MEMBERS --}}
    {{-- START POSTS --}}
    <section class="container mx-auto px-5 sm:px-0 mt-[5rem]">
        <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] text-[#098752] text-center font-bold mb-[2rem]">Actualité
            et Evènements</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="h-[250px] flex border rounded-md">
            ...
            <div class="h-[250px] flex border rounded-md">
                ...
                <div class="p-2 w-2/3">
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] mb-[1rem]">Atelier : Stratégies Digitales
                        pour 2025</h1>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Une formation interactive sur les nouvelles
                        tendances en communication digitale et les outils à
                        maîtriser.</p>
                </div>
            </div>
            ...
            <div class="h-[250px] flex border rounded-md">
                ...
                <div class="p-2 w-2/3">
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] mb-[1rem]">Lancement du Réseau des
                        Communicants Francophones</h1>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Un espace collaboratif en ligne permettant aux
                        professionnels de partager ressources et opportunités.
                    </p>
                </div>
            </div>
            ...
            <div class="h-[250px] flex border rounded-md">
                ...
                <div class="p-2 w-2/3">
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] mb-[1rem]">Prix d’Excellence en
                        Communication</h1>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem]">Une cérémonie annuelle récompensant les
                        meilleures campagnes et initiatives en communication et
                        marketing.</p>
                </div>
            </div>
        </div>
        ...
        <div class="testimonial-slider">
            <div>
                <div class="flex flex-col gap-2 p-2 items-center">
                    ...
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] font-bold">Marc D.</h1>
                    <h2 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem]">Consultant en communication</h2>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem] text-center">"Grâce à l'association, j’ai pu
                        élargir mon réseau et découvrir des opportunités
                        incroyables. Une
                        vraie
                        communauté de soutien !"</p>
                </div>
            </div>
            ...
            <div>
                <div class="flex flex-col gap-2 p-2 items-center">
                    ...
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] font-bold">Sophie K.</h1>
                    <h2 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem]">Étudiante en marketing</h2>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem] text-center">"Les ateliers et formations
                        proposés m’ont permis d’acquérir des compétences
                        pratiques qui me servent au quotidien."</p>
                </div>
            </div>
            ...
            <div>
                <div class="flex flex-col gap-2 p-2 items-center">
                    ...
                    <h1 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem] font-bold">Jean-Pierre L.</h1>
                    <h2 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem]">Directeur d’agence</h2>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem] text-center">"Adhérer à l’APC nous a permis de
                        collaborer avec des experts et d’accéder à des
                        ressources exclusives."</p>
                </div>
            </div>
            ...
            <div>
                <div class="flex flex-col gap-2 p-2 items-center">
                    ...
                    <h2 class="text-[1rem] md:text-[1.125rem] lg:text-[1.25rem]">Consultant en communication</h2>
                    <p class="text-[0.875rem] md:text-[1rem] lg:text-[1rem] text-center">"Grâce à l'association, j’ai pu
                        élargir mon réseau et découvrir des
                        opportunités incroyables. Une
                        vraie
                        communauté de soutien !"</p>
                </div>
            </div>
    ...
    {{-- END TESTIMONIALS --}}
    {{-- START GALERIE --}}
    <section id="gallery" class="mt-[5rem] bg-[#e7f1ea] py-[3rem]">
        <h1 class="text-[1.25rem] md:text-[1.5rem] lg:text-[2rem] text-[#098752] text-center font-bold mb-[2rem]">Galerie
            Photos/Vidéos</h1>
        <div class="container mx-auto px-5 sm:px-0">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a data-flickr-embed="true"
                    href="https://www.flickr.com/photos/lesprosdelacommdubenin/albums/72177720322474817"
                    title="Forum des Métiers de la Comm&#x27;"><img
                        src="https://live.staticflickr.com/65535/54195655275_d7081379ea_z.jpg" class="w-full h-full"
                        alt="Forum des Métiers de la Comm&#x27;" /></a>
                <script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>

                <a data-flickr-embed="true"
                    href="https://www.flickr.com/photos/lesprosdelacommdubenin/albums/72177720321745582"
                    title="La Marche des Pros de la Comm&#x27; du Bénin"><img
                        src="https://live.staticflickr.com/65535/54121239488_52e326b2e6_z.jpg" class="w-full h-full"
                        alt="La Marche des Pros de la Comm&#x27; du Bénin" /></a>
                <script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>

                <a data-flickr-embed="true" data-context="true"
                    href="https://www.flickr.com/photos/lesprosdelacommdubenin/54195456543/in/photostream/"
                    title="FORUM DES MÉTIERS DE LA COMM | ÉDITION 1"><img
                        src="https://live.staticflickr.com/65535/54195456543_0d3d27b9f2_k.jpg" class="w-full h-full"
                        alt="FORUM DES MÉTIERS DE LA COMM | ÉDITION 1" /></a>
                <script async src="//embedr.flickr.com/assets/client-code.js" charset="utf-8"></script>
            </div>
            <div class="text-center my-[2rem]">
                <a class="text-[1rem] text-[#000000] hover:text-[#000000] hover:underline cursor-pointer"
                    href="https://www.flickr.com/photos/lesprosdelacommdubenin/" target="_blank">Voir plus <span
                        class="fa fa-arrow-right"></span> </a>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <iframe class="w-full h-full" src="https://www.youtube.com/embed/ShzZtvvkCcw?si=IX3WFGMyKD4cFTlu"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

                <iframe class="w-full h-full" src="https://www.youtube.com/embed/5AlURKF476w?si=OvPlmQhSwqvFe199"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

                <iframe class="w-full h-full" src="https://www.youtube.com/embed/B750OtTpdS4?si=4gBFEZt-M5uZ_wHl"
                    title="YouTube video player" frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            ...
            <div class="text-center mt-[2rem]">
                <a class="text-[1rem] text-[#000000] hover:text-[#000000] hover:underline cursor-pointer"
                    href="https://www.youtube.com/@LesProsdelaCommBenin" target="_blank">Voir plus <span
                        class="fa fa-arrow-right"></span> </a>
            </div>
        </div>
    </section>
    ...
    <section class="container mx-auto px-5 sm:px-0 my-[5rem]">
        ...
        <div class="text-center my-[2rem]">
            <button
                class="px-[1.5rem] py-[.8rem] bg-[#000000] text-[#FFFFFF] hover:bg-[#098752] hover:text-[#ffff] transition-all ease-in-out duration-300 rounded-md font-bold cursor-pointer">Devenir
                partenaire</button>
        </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="card features main-features main-features-1 wow fadeInUp reveal revealleft"
                                    ...
                                    <div class="text-left">
                                        ...
                                        <p class="mb-0">The Sash admin code is maintained very
                                            cleanly
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 pe-0 my-auto">
                                                ...
                                                <div class="ps-5 reveal revealright">
                                                    <h2 class="text-start fw-semibold fs-25 mb-6">We
                                                        are
                                            ...
                                            <div class="card p-3 border-primary pricing-card advanced reveal revealrotate">
                                                <div class="card-header d-block text-justified pt-2">
                                                    <p class="fs-18 fw-semibold mb-1 pe-0">
                                                        Advanced<span class="tag bg-primary text-white float-end">Limited
                                                            Deal</span></p>
                                                    <p class="text-justify fw-semibold mb-1"> <span
                                                            class="fs-30 me-2">$</span><span
                                                    ...
                                                    <p class="fs-13 mb-2">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
                                                    <p class="fs-13 mb-1 text-primary">Billed monthly
                                                        on
                                                        regular basis!</p>
                                                </div>
                                                <div class="card-body pt-2">
                                            ...
                                            <div class="card p-3 pricing-card reveal revealrotate">
                                                <div class="card-header d-block text-justified pt-2">
                                                    ...
                                                    <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                        consectetur adipisicing elit. Iure quos debitis
                                                        aliquam .</p>
                                                    <p class="fs-13 mb-1  text-danger">Billed monthly
                                                        on
                                                        regular basis!</p>
                                                </div>
                                                <div class="card-body pt-2">
                                    ...
                                    <div class="testimonial-carousel">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-8 col-md-12 d-block mx-auto">
                                                    <div class="testimonia">
                                                        ...
                                                        <div class="rating-stars block my-rating-5 mb-5" data-rating="4">
                                                        </div>
                                        ...
                                        <div class="slide text-center">
                                            <div class="row">
                                                <div class="col-xl-8 col-md-12 d-block mx-auto">
                                                    <div class="testimonia">
                                                        <p class="text-white-80"><i class="fa fa-quote-left fs-20"></i>
                                                            Nemo
                                                            enim ipsam
